...
- Defines a route for '/number_template/<n>' to display a HTML page.
- Defines a route for '/number_odd_or_even/<n>' to display a HTML page.
...
def is_number_html(n):
    """
    Defines a route for /number_template/ to display a HTML page
    only if 'n' is an integer
    """
    n = str(n)
...
def odd_or_even_num(n):
    """
    Defines a route for /number_odd_or_even/ to display a HTML page
    only if 'n' is an integer
    """
